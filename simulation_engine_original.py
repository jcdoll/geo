...
class GeologySimulation:
    ...
    def _update_material_properties(self):
        ...
        # Clean up cache: remove materials no longer present in the grid
        cached_materials = set(self._material_props_cache.keys())
        obsolete_materials = cached_materials - unique_materials
        for material in obsolete_materials:
            del self._material_props_cache[material]
